...
describe('OriginERC721_v5Factory', () => {
  describe('Token with limited supply of 10', () => {
    ...
    it('Can create token with a minter', async () => {
      ...
      const { factoryV5, master, nftv5 } = await loadFixture(defaultFixture)
  ...
  describe('Payment splits', () => {
    ...
    before(async () => {
      const { factoryV5, master, deployer, nftv5 } = await loadFixture(
        defaultFixture
      )
