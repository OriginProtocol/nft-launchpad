...
describe('OriginERC721a_v1', () => {
  ...
  describe('Payment splits', () => {
    ...
    before(async () => {
      ...
      const erc721aFactory = await ethers.getContractFactory('OriginERC721a_v1')
